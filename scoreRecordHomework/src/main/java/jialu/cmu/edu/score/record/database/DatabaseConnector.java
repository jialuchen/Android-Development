package jialu.cmu.edu.score.record.database;
...
public class DatabaseConnector {
    ...
    public static final String TABLE_NAME = "ScoreRecord"; 

    // set the column name for each column
    public static final String ID = "ID";
    public static final String Q1 = "Q1";
    public static final String Q2 = "Q2";
    public static final String Q3 = "Q3x";
    public static final String Q4 = "Qx4";
    public static final String Q5 = "Qx5";
